-- TRUNCATE TABLES
TRUNCATE TABLE order_item, pizza_order, customer, pizza CASCADE;
...
VALUES
(1, '192758012', NOW() - INTERVAL '5 days', 42.95, 'D', 'Don''t be late pls.'),
...
(6, '782668115', NOW(), 23.0, 'D', NULL);


ALTER TABLE order_item DROP CONSTRAINT order_item_pkey;

ALTER TABLE order_item
ADD CONSTRAINT order_item_pkey PRIMARY KEY (id_order, id_item);
